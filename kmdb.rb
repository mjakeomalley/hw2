...
for movie in movies
    ...
    puts "#{movie["title"]}".ljust(25) + "#{movie["year_released"]}".ljust(8) + "#{movie["rated"]}".ljust(8) + "#{studio["name"]}"
end
...
for role in roles
    ...
    puts "#{movie["title"]}".ljust(25) + "#{actor["name"]}".ljust(23) + "#{role["character_name"]}"
end
